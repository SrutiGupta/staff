...
async function testPrint() {
  if (!PRINTER_IP || !PRINTER_PORT) {
    console.error('Error: Please set THERMAL_PRINTER_IP and THERMAL_PRINTER_PORT in your .env file.');
    return;
  }
  ...
  try {
    ...
    const authToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdGFmZklkIjoxLCJpYXQiOjE3NTY1ODgxNzksImV4cCI6MTc1NjU5MTc3OX0.p4Cmrimk0X7sLUkoSvbxvj2VkxStsY7g7Cho1XHQlcs";

    const response = await axios.get(`${API_BASE_URL}/invoice/${invoiceId}/thermal`, {
